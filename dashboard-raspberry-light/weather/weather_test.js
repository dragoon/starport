const weatherMap = {
    1: {type: 'thunder', intensity: 2.5, icon: 'wi-thunderstorm', name: 'Tropical Storm'}, //tropical storm
    2: {type: 'thunder', intensity: 5, icon: 'wi-hurricane', name: 'Hurricane'}, //hurricane
    3: {type: 'thunder', intensity: 1.25, icon: 'wi-thunderstorm', name: 'Severe Thunderstorms'}, //severe thunderstorms

...
document.addEventListener('mousemove', function (e) {
    ...
    document.getElementById("sun").style.background = '-webkit-radial-gradient(' + x + 'px ' + y + 'px, circle, rgba(242,248,247,1) 0%,rgba(249,249,28,1) 3%,rgba(247,214,46,1) 8%, rgba(248,200,95,1) 12%,rgba(201,165,132,1) 30%,rgba(115,130,133,1) 51%,rgba(46,97,122,1) 85%,rgba(24,75,106,1) 100%)';
    document.getElementById("sun").style.background = '-moz-radial-gradient(' + x + 'px ' + y + 'px, circle, rgba(242,248,247,1) 0%,rgba(249,249,28,1) 3%,rgba(247,214,46,1) 8%, rgba(248,200,95,1) 12%,rgba(201,165,132,1) 30%,rgba(115,130,133,1) 51%,rgba(46,97,122,1) 85%,rgba(24,75,106,1) 100%)';
    document.getElementById("sun").style.background = '-ms-radial-gradient(' + x + 'px ' + y + 'px, circle, rgba(242,248,247,1) 0%,rgba(249,249,28,1) 3%,rgba(247,214,46,1) 8%, rgba(248,200,95,1) 12%,rgba(201,165,132,1) 30%,rgba(115,130,133,1) 51%,rgba(46,97,122,1) 85%,rgba(24,75,106,1) 100%)';
    ...
    if (y > 0) {
        if (y > myHeight / 2) {
            document.getElementById("sun").style.opacity = Math.min((myHeight - y) / (myHeight / 2) + 0.2, 0.5);
